...
public class HappyPet {
	...
	public static void main(String[] args) {
		...
		while (happinessValue < 100) {
			...
			// partner for life", 0, JOptionPane.INFORMATION_MESSAGE, null, new String[] {
			// "Dog", "Cat", "Fish", "Bird"}, null);
...
happinessValue = 0 + 1;
JOptionPane.showMessageDialog(null, "Your pet is thankful for the cleanliness!");
	}
